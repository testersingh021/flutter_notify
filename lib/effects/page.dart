...
class AlicePage extends StatelessWidget {
  final int page;
  final List<PdfPageImage> listpageImage;

  const AlicePage({ Key? key, required this.page, required this.listpageImage}) : super(key: key);
  @override
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    width: 160.0,
                    height: 220.0,
                    child: listpageImage.isEmpty && page> listpageImage.length
                        ? const Placeholder()
                        : Placeholder()
                   // Image(image: MemoryImage(listpageImage[page-1].bytes),),
                  ),
                ],
              ),
